...
def home():
    ...
    if request.method == 'POST':
        ...
        oneliner = generate_oneliner(customer_key, branch, tag, product, hand_side, reinstall, ethercat_right_arm, arm_ip_right, ethercat_left_arm, arm_ip_left, ur_robot_type)

    return render_template('index.html', oneliner=oneliner)

def generate_oneliner(customer_key, branch, tag, product, hand_side, reinstall, ethercat_right_arm, arm_ip_right, ethercat_left_arm, arm_ip_left, ur_robot_type):
